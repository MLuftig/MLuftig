...
### 1. [Animal Shelter Recidivism Prediction]([https://github.com](https://github.com/MLuftig/animal-shelter-recidivism-prediction))
...
* **Libraries & Frameworks:** Pandas, NumPy, Scikit-Learn, SciPy, Seaborn, Matplotlib
* **Core Competencies:** Relational Database Joins, Non-Parametric Hypothesis Testing, Ensemble Machine Learning Models, Data Cleansing & ETL Pipeline Architecture

---

## License & Contact
Distributed under the MIT License. For questions or professional collaboration regarding veterinary informatics and data analytics, reach out via [LinkedIn]((https://www.linkedin.com/in/micah-luftig/)).
